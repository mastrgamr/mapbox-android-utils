...
public class CameraActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMapView.setAccessToken("pk.eyJ1Ijoic3R1YXJ0c21pdGgiLCJhIjoiODViYzQxYzI1NDIwYjAyZDAyOWMxYTgyODNlYzA1MWEifQ.-TwasPtFPu9OfF3D2io44A");
        mMapView.onCreate(savedInstanceState);
        mMapView.getMapAsync(new OnMapReadyCallback() {
            private int CAMERA_MOVE_REACT_THRESHOLD_MS = 500;
            long moveStep = System.currentTimeMillis();
            ...
            public void onMapReady(@NonNull final MapboxMap mapboxMap) {
                ...
                mapboxMap.setOnCameraChangeListener(new MapboxMap.OnCameraChangeListener() {
                    ...
                    public void onCameraChange(CameraPosition position) {
                        if(System.currentTimeMillis() - moveStep > CAMERA_MOVE_REACT_THRESHOLD_MS) {
                            Log.v(MapboxConstants.TAG, position.toString());
                            moveStep = System.currentTimeMillis();
                        }
