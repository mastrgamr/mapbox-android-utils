...
import static net.mastrgamr.mbmapboxutils.MathUtil.EARTH_RADIUS;
import static net.mastrgamr.mbmapboxutils.MathUtil.clamp;
import static net.mastrgamr.mbmapboxutils.MathUtil.hav;
import static net.mastrgamr.mbmapboxutils.MathUtil.havDistance;
import static net.mastrgamr.mbmapboxutils.MathUtil.havFromSin;
import static net.mastrgamr.mbmapboxutils.MathUtil.inverseMercator;
import static net.mastrgamr.mbmapboxutils.MathUtil.mercator;
import static net.mastrgamr.mbmapboxutils.MathUtil.sinFromHav;
import static net.mastrgamr.mbmapboxutils.MathUtil.sinSumFromHav;
import static net.mastrgamr.mbmapboxutils.MathUtil.wrap;
import static net.mastrgamr.mbmapboxutils.SphericalUtil.computeDistanceBetween;
