...
import net.mastrgamr.mbmapboxutils.R;
...
import net.mastrgamr.mbmapboxutils.geometry.Point;
import net.mastrgamr.mbmapboxutils.projection.SphericalMercatorProjection;
import net.mastrgamr.mbmapboxutils.ui.IconGenerator;
import net.mastrgamr.mbmapboxutils.ui.SquareTextView;
...
public class DefaultClusterRenderer<T extends ClusterItem> implements ClusterRenderer<T> {
     ...
     */
    private SparseArray<Icon> mIcons = new SparseArray<Icon>();
    ...
    @Override
    public void onAdd() {
        mClusterManager.getMarkerCollection().setOnMarkerClickListener(new MapboxMap.OnMarkerClickListener() {
            @Override
        ...
        mClusterManager.getMarkerCollection().setOnInfoWindowClickListener(new MapboxMap.OnInfoWindowClickListener() {
            @Override
        ...
        mClusterManager.getClusterMarkerCollection().setOnMarkerClickListener(new MapboxMap.OnMarkerClickListener() {
            @Override
            public boolean onMarkerClick(Marker marker) {
        ...
        mClusterManager.getClusterMarkerCollection().setOnInfoWindowClickListener(new MapboxMap.OnInfoWindowClickListener() {
            @Override
            public boolean onInfoWindowClick(Marker marker) {
    ...
    private static Point findClosestCluster(List<Point> markers, Point point) {
        ...
        // TODO-Google: make this configurable.
        double minDistSquared = 100 * 100; //MAX_DISTANCE_AT_ZOOM * MAX_DISTANCE_AT_ZOOM;
        Point closest = null;
    ...
    protected void onBeforeClusterRendered(Cluster<T> cluster, MarkerOptions markerOptions) {
        ...
        if (descriptor == null) {
            ...
            descriptor = IconFactory.getInstance(context).fromBitmap(mIconGenerator.makeIcon(getClusterText(bucket)));
